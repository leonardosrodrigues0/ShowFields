...
public class DrawLinesView: UIView {

    public static let defaultStrokeColor = CGColor(red: 0, green: 1, blue: 1, alpha: 1)
    ...
    public init(frame: CGRect, strokeColor: CGColor = defaultStrokeColor, lineWidth: CGFloat = 1) {
